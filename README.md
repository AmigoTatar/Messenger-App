...
Веб и APK после пакетов 17–19 авг закрывают списки багов этих дней **в коде**. Чтобы это было на проде, нужна заливка сервера + миграции + новая сборка клиента (см. `DEPLOY.md`).
...
13. Жалоба → письмо на `REPORT_EMAIL` (если задан) и запись в 🛡️ у админа.
